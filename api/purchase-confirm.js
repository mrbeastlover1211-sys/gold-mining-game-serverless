      ...
      try {
        ...
        if (sessionId) {
          ...
          if (challengeCheck.length > 0) {
            ...
            // ✅ Correct Netherite Challenge reward:
            // - The BUYER gets the Netherite pickaxe they purchased (already handled above)
            // - The REFERRER should receive +1 Netherite pickaxe if within the challenge window
            ...
            // Load referrer and grant 1x netherite pickaxe + mining power
            ...
            // Netherite ratePerSec is 1000/60, so per-minute power = 1000.
            // In this codebase total_mining_power is per-minute units.
            ...
            // Mark the challenge as awarded for reporting/debugging
            await sql`
